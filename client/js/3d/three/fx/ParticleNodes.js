...
*/
            const frictionMod = ONE.sub(max(0, min(frictionColor.r, 1)));
            ...
            const velocityOffset = vec3(pVelocityX.mul(frictionMod), pVelocityY.mul(frictionMod), pVelocityZ.mul(frictionMod)).mul(age);
