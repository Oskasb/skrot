    ...
    constructor() {
        ...
        function setLodLevel(lodL) {
            ...
            if (lodLevel < minLodLevel) {
                ...
                if (plantIsActive === false) {
                    plantIsActive = true;
                    activateBatchedPlant()
                    return;
                }
        ...
        function init(fName, trxObj3d, indPos, minLodLvl) {
            fileName = fName;
        ...
        this.call = {
            init:init,
            activateForestTree:activateBatchedPlant,
